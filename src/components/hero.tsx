...
function Hero() {
  ...
  return (
    <main className="flex  flex-col items-center justify-center min-h-screen pt-40">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-[1200px] mx-auto place-items-center px-2 lg:px-0">
        <div className={cn("flex flex-col gap-4 items-start justify-center")}>
          <TypingAnimation
            ...
            text={tr("title")[1]}
          />
          <h1 className="text-2xl md:text-4xl font-bold text-left max-w-2xl">
      ...
      <div
        className={cn(
          "relative grid grid-cols-1 md:grid-cols-2 gap-4 mt-8 max-w-[1200px] mx-auto",
          // center everything
          "place-items-center"
        )}
      >
        <div className="sticky flex gap-4 flex-col items-stretch px-3 lg:px-0">
